...
export default function NovelCard({ novel }: NovelCardProps) {
  ...
  return (
    <div>
        ...
        <Card className="h-full hover:shadow-2xl transition-all duration-300 cursor-pointer novel-card-dark border-white/10 hover:border-purple-400/50 flex flex-col">
          ...
          <CardFooter className="p-4 pt-0 mt-auto">
            <div className="w-full">
              ...
              <button
                className="mt-3 w-full bg-purple-700 text-white rounded px-3 py-2 font-semibold hover:bg-purple-800 transition"
                onClick={(e) => {
                  e.preventDefault();
                  setShowChapters((v) => !v);
                }}
      ...
      {showChapters && (
        <div className="bg-gray-900 border border-purple-700 rounded-b-lg p-4 mt-[-8px]">
          <h4 className="font-bold text-purple-300 mb-2">Chapters</h4>
